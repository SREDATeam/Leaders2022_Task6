...
def analyse(request):
    ...
    return JsonResponse({"pool": res.to_dict("records"), "analogs": [analogs[i].to_dict("records") for i in analogs], "ranked_etalons": ranked_etalons.to_dict("records")}, safe=False)
